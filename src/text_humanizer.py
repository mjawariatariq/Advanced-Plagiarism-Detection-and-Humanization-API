...
Rewritten text:"""
    ...
    def _clean_text(self, text: str) -> str:
        """Clean Gemini response to extract ONLY the rewritten text."""
        text = text.strip()
        
        # If the response starts with a header like "Here are a few ways..."
        # Extract just the actual rewritten content
        lines = text.split('\n')
        cleaned_lines = []
        ...
        # If nothing was kept, return original text
